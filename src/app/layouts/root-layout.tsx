...
export default function RootLayout() {
  return (
    <div class="grid w-full auto-rows-auto grid-cols-1 text-fluid-base">
      <div class="grid min-h-dvh grid-rows-[auto_1fr]">
        <header class="@container bg-yellow-200 px-[clamp(0.25rem,4dvi,3rem)] py-1 text-fluid-2xl text-walnut">
          <Link
            to="/"
